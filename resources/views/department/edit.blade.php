  ...
  <div class="column">
    ...
    <div class="col-md-6">
      <div class="input-group input-group-outline my-3" required>
        ...
        <input type="text" name="department" class="form-control" autocomplete="off" value="{{ $department->department }}">
      </div>
    </div>
    <div class="col-md-6">
      <div class="input-group input-group-outline my-3">
        <button class="btn btn-outline-danger rounded w-100" type="submit">Update</button>
      </div>
    </div>
  </div>
</form>
